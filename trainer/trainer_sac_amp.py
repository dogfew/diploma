...
class Trainer3(BaseTrainer):
    ...
    def __init__(
        ...
        state_dim, action_dim = get_state_dim(
            market, limit=environment.limit
        ), get_action_dim(market, limit=environment.limit)
        n_firms = market.n_firms
        # Replay Buffer
        self.buffer = ReplayBuffer(
            state_dim=state_dim, action_dim=action_dim, n_firms=n_firms, size=100_000
        )
        ...
        self.scaler = GradScaler(init_scale=512, enabled=use_amp)
